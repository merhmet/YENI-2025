const menuArray = [
    {
        name: "Pizza",
        image: "https://i.postimg.cc/GTrNLRTR/pizza.png",
    ...
    {
        name: "Hamburger",
        image: "https://i.postimg.cc/1nD21XtM/hamburger.png",
        ...
        {
        name: "Beer",
        image: "https://i.postimg.cc/Jsd9bSv3/beer.png",
...
function collectItemsHTML() {
    menuArray.forEach(function(item) {
        itemsContent += `
            <div class="item">
              <div class="item__img">
                <img id="item__img" width="80px" src="${item.image}" alt="" />
              </div>
