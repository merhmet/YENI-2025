document.addEventListener('click', function (event) {
    ...
    var vppDisplay = event.target.getAttribute("data-fsc-vpp-display");
    var vppDesc = event.target.getAttribute("data-fsc-vpp-desc");
    var vppImage = event.target.getAttribute("data-fsc-vpp-image");
		var cart = event.target.getAttribute("data-fsc-cart");
		fsaddProd(product, vppDisplay, vppDesc, vppImage, cart);
		return
	}
...
function fsaddProd(prod, vppDisplay, vppDesc, vppImage, type) {
    ...
    // Create and add a new virtual product to the session.
